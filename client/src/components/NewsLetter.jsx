    ...
    <div>
      <div>
        <h3 className='text-lg font-bold mb-2 flex items-center gap-2'>
            ...
            <p className='text-primary/75 text-base mb-4'>Mollit in laborum tempor Lorem incididunt irure. Aute eu ex ad sunt.Mollit in laborum tempor Lorem incididunt irure.</p>
